...
public class MarkerdanShape {
    ...
    public MarkerdanShape(String marker, String universitas_multimedia_nusantara, double v, List<LatLng> lokalTitiks) {
    }

    public void MarkerDanShape(String jenis, String keterangan,
